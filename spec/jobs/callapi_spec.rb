  ...
  describe 'run.sh.erb' do
    ...
    describe 'providing a call' do
      ...
      let(:valid_rendered_request) {
        "request_elk PUT /_ilm/policy/datastream_policy"
      }

      let(:valid_rendered_payload) {
        '{"policy":{"phases":{"hot":{"min_age":"0ms","actions":{"rollover":{"max_age":"1d"}}},"delete":{"min_age":"7d","actions":{"delete":{}}}}}}'
      }
      ...
      it 'renders properly' do
        ...
        # expect(rendered_template).to include(valid_rendered_payload.to_json.to_s)
